...
class Titlebar(Gtk.EventBox):
    ...
    def __init__(self, terminal):
        ...
        grouphbox.set_child_packing(self.groupicon, False, True, 2, Gtk.PackType.START)
        grouphbox.append(self.grouplabel)
        grouphbox.set_child_packing(self.grouplabel, False, True, 2, Gtk.PackType.START)
        grouphbox.append(self.groupentry)
        grouphbox.set_child_packing(self.groupentry, False, True, 2, Gtk.PackType.START)
        ...
        hbox.set_child_packing(self.ebox, False, True, 0, Gtk.PackType.START)
        hbox.append(Gtk.VSeparator())
        hbox.set_child_packing(Gtk.VSeparator(), False, True, 0, Gtk.PackType.START)
        hbox.append(viewport)
        hbox.set_child_packing(viewport, True, True, 0, Gtk.PackType.START)
        hbox.append(self.bellicon)
        hbox.set_child_packing(self.bellicon, False, False, 2, Gtk.PackType.END)
